...
<div class="page w3-content" style="max-width:1500px">
	...
	<div class="w3-display-middle" style="background-color:#060360;">
		<p class="w3-margin-right w3-margin-left" style="color:#ffffff"><i class="fas fa-check w3-margin-right" style="color:#ffffff"></i>Account could not be verfied. Please try again.</p>
	</div>
	
	<button class="sB w3-display-middle w3-button" style="background-color:#060360; color:#ffffff"><a href="http://daredicing.com/login.php"><i class="fas fa-sign-out-alt"></i>Return to Login page</button></a>
