...
if($conn === false){
                    ...
                    if ($votedrows == 1)
                    {
                    $upvInsert = "INSERT INTO Votes (PostID, UserID, VoteType) VALUES ($postID, $LoggedInUserID, '0');";
                    }else{
                    $upvInsert = "UPDATE Votes SET VoteType = '0' WHERE (PostID=$postID AND UserID=$LoggedInUserID);";
                    }
